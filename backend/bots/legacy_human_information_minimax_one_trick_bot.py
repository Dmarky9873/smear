...
class LegacyHumanInformationMinimaxOneTrickPlayer(
    LegacyOmniscientMinimaxOneTrickPlayer
):
    ...
    def choose_card(self, round_state: RoundState) -> Card:
        ...
        completed_units = 0
        self.begin_progress(
            label="Searching sampled worlds",
...
LegacyMinimaxOneTrickPlayer = LegacyHumanInformationMinimaxOneTrickPlayer
