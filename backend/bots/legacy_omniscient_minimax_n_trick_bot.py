...
class LegacyOmniscientMinimaxNTrickPlayer(LegacyOmniscientMinimaxOneTrickPlayer):
...
LegacyOMNISCIENT_MinimaxNTrickPlayer = LegacyOmniscientMinimaxNTrickPlayer
